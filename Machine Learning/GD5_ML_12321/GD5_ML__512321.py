...
# ================================
st.set_page_config(
    page_title="Dinarradja Housing Prediction",
    page_icon="🏠",
    layout="centered"
)
...
# ================================
st.markdown("---")
st.subheader("ℹ️ Penjelasan Prediksi")
...
- **MAE Train:** ± **${MODEL_MAE_TRAIN:,.0f}**
- **MAE Test:** ± **${MODEL_MAE_TEST:,.0f}**
- **R² Train:** **{MODEL_R2_TRAIN:.2f}**
- **R² Test:** **{MODEL_R2_TEST:.2f}**
...
- Prediksi adalah **estimasi**, bukan harga pasti — ada margin error yang wajar.
